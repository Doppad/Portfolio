...
export const OnOff = (props) => {
  return (
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
      width="112.000000pt" height="112.000000pt" viewBox="0 0 512.000000 512.000000"
      preserveAspectRatio="xMidYMid meet">

      <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
        fill="#000000" stroke="none">
        <path d="M2474 5095 c-28 -14 -59 -40 -74 -62 l-25 -37 -3 -1118 c-2 -1098 -2
-1119 18 -1157 68 -135 273 -134 339 2 l21 44 -2 1115 -3 1116 -31 39 c-36 46
-105 83 -154 83 -20 0 -58 -11 -86 -25z"/>
        <path d="M1013 3899 c-67 -33 -218 -205 -340 -386 -79 -119 -210 -384 -252
-511 -40 -121 -76 -265 -96 -382 -22 -130 -31 -438 -16 -581 62 -596 347
-1134 804 -1516 607 -507 1451 -658 2202 -392 316 111 575 273 824 514 382
371 616 856 672 1394 15 142 6 451 -16 581 -51 303 -157 586 -315 841 -98 158
-280 379 -350 425 -99 66 -232 27 -281 -81 -39 -85 -21 -148 72 -251 347 -385
511 -800 511 -1289 0 -371 -89 -685 -283 -997 -338 -545 -940 -878 -1589 -878
-934 0 -1712 671 -1855 1600 -20 126 -22 400 -5 515 58 392 209 720 462 1007
92 103 127 162 128 208 1 145 -150 242 -277 179z"/>
      </g>
    </svg>
  )
}
...
export const Instagram = (props) => {
  return (
    ...
    >
      ...
      />
      <circle fill={props.fill} cx={418.306} cy={134.072} r={34.149} />
    </svg>
  )
}

export const Vkontacte = (props) => {
  return (
    <svg
      data-name="Layer 45"
      height={24}
